...
### `gmail`
Gmail workflow skill for mailbox checks, mailbox triage, latest-thread opening, compose and reply task runners, tab hygiene, send verification, blockers, and proof-aware execution.
